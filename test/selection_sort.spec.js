...
const selectionSort = require("../selection_sort/selection_sort");

describe("Selection sort in ascending order tests for unsorted list of numbers", function () {
  
  it("current [0, 1, 2, 3, 4, 5], should return [0, 1, 2, 3, 4, 5]", () => {
    const truthful = [0, 1, 2, 3, 4, 5];
    const numbersList = [0, 1, 2, 3, 4, 5];
    assert.deepEqual(selectionSort(numbersList), truthful);
  });
